...
$(document).ready(function() {
	...
	if(jQuery.event.props != undefined) {
	...
	function addImage(ind) {
		...
		for (i = start; i < end; i++) {
			...
			if($('#dropped-files > .image').length <= maxFiles) { 
				$('#dropped-files').append('<div id="img-'+i+'" class="image" style="background: url('+dataArray[i].value+'); background-size: contain; background-repeat: no-repeat; background-position: top;"> <a href="#" id="drop-'+i+'" class="drop-button">Delete</a></div>');
			}
		}
		return false;
	}
